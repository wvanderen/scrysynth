...
- [x] **NODES-04**: User can add a step-sequencer node with per-step gate/CV and clock transport
- [x] **NODES-05**: Every audio node exposes CV/modulation inputs (audio-rate + control-rate ports), making patches modular, not preset-based
...
|-------------|-------|--------|
| NODES-01 | Phase 12 (Node Catalog Foundation) | Complete (Plan 01 + 02) |
| NODES-02 | Phase 12 (Node Catalog Foundation) | Complete (Plan 01) |
| NODES-03 | Phase 12 (Node Catalog Foundation) | Complete (Plan 01) |
| NODES-04 | Phase 12 (Node Catalog Foundation) | Complete (Plan 02) |
| NODES-05 | Phase 12 (Node Catalog Foundation) | Complete (Plan 01 + 02) |
...
*Last updated: 2026-06-26 after Phase 12 completion (NODES-01..05 verified; real-scsynth conformance passes locally)*
